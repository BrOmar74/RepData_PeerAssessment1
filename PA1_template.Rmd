---
title: "Assignment Week2 Reproducible research"
...
The mean across all days and intervals **is `r as.integer(mean(data_total_day$steps))`**
...
The median across all days and intervals **is `r as.integer(median(data_total_day$steps))`** 
...
The total number of missing values in the dataset (i.e. the total number of rows with NAs) **is `r sum_na`**  
...
The mean across all days and intervals **is `r as.integer(mean(data_total_filled$steps))`**
...
The median across all days and intervals **is `r as.integer(median(data_total_filled$steps))`**  
